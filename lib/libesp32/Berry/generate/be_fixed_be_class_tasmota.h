...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(time_str, 18), be_const_closure(Tasmota_time_str_closure) },
    { be_const_key(millis, 50), be_const_func(l_millis) },
    ...
    { be_const_key(eth, 37), be_const_func(l_eth) },
    ...
    { be_const_key(publish, 61), be_const_func(be_mqtt_publish) },
    { be_const_key(_debug_present, 32), be_const_var(0) },
    { be_const_key(add_fast_loop, 6), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(cmd_res, -1), be_const_var(1) },
    { be_const_key(fast_loop, 24), be_const_closure(Tasmota_fast_loop_closure) },
    { be_const_key(exec_cmd, 4), be_const_closure(Tasmota_exec_cmd_closure) },
    { be_const_key(urlfetch, -1), be_const_closure(Tasmota_urlfetch_closure) },
    { be_const_key(strftime, -1), be_const_func(l_strftime) },
    { be_const_key(remove_cron, 17), be_const_closure(Tasmota_remove_cron_closure) },
    ...
    { be_const_key(next_cron, 48), be_const_closure(Tasmota_next_cron_closure) },
    { be_const_key(wd, -1), be_const_var(3) },
    { be_const_key(add_cron, -1), be_const_closure(Tasmota_add_cron_closure) },
    { be_const_key(memory, 73), be_const_func(l_memory) },
    ...
    { be_const_key(rtc, 54), be_const_func(l_rtc) },
    { be_const_key(response_append, -1), be_const_func(l_respAppend) },
    { be_const_key(gen_cb, 11), be_const_closure(Tasmota_gen_cb_closure) },
    { be_const_key(get_light, -1), be_const_closure(Tasmota_get_light_closure) },
    { be_const_key(i2c_enabled, 36), be_const_func(l_i2cenabled) },
    { be_const_key(publish_result, -1), be_const_func(l_publish_result) },
    { be_const_key(resp_cmnd_error, 74), be_const_func(l_respCmndError) },
    { be_const_key(scale_uint, -1), be_const_func(l_scaleuint) },
    { be_const_key(cmd, -1), be_const_closure(Tasmota_cmd_closure) },
    { be_const_key(save, 64), be_const_func(l_save) },
    { be_const_key(get_free_heap, -1), be_const_func(l_getFreeHeap) },
    { be_const_key(get_power, 82), be_const_func(l_getpower) },
    { be_const_key(load, -1), be_const_closure(Tasmota_load_closure) },
    { be_const_key(set_power, 70), be_const_func(l_setpower) },
    { be_const_key(_global_def, 38), be_const_comptr(&be_tasmota_global_struct) },
    { be_const_key(remove_cmd, 34), be_const_closure(Tasmota_remove_cmd_closure) },
    { be_const_key(web_send_decimal, 65), be_const_func(l_webSendDecimal) },
    { be_const_key(settings, 87), be_const_var(4) },
    { be_const_key(_drivers, -1), be_const_var(5) },
    { be_const_key(find_key_i, -1), be_const_closure(Tasmota_find_key_i_closure) },
    { be_const_key(arch, 29), be_const_func(l_arch) },
    { be_const_key(wire2, 60), be_const_var(6) },
    { be_const_key(wire1, -1), be_const_var(7) },
    { be_const_key(get_switches, 78), be_const_func(l_getswitch) },
    { be_const_key(global, 80), be_const_var(8) },
    ...
    { be_const_key(event, 45), be_const_closure(Tasmota_event_closure) },
    { be_const_key(publish_rule, -1), be_const_func(l_publish_rule) },
    { be_const_key(add_driver, 0), be_const_closure(Tasmota_add_driver_closure) },
    ...
    { be_const_key(resp_cmnd_done, 79), be_const_func(l_respCmndDone) },
    ...
    { be_const_key(read_sensors, 39), be_const_func(l_read_sensors) },
    { be_const_key(check_not_method, -1), be_const_closure(Tasmota_check_not_method_closure) },
    { be_const_key(urlfetch_cmd, 26), be_const_closure(Tasmota_urlfetch_cmd_closure) },
    { be_const_key(wifi, 53), be_const_func(l_wifi) },
    { be_const_key(remove_timer, -1), be_const_closure(Tasmota_remove_timer_closure) },
    { be_const_key(run_deferred, 40), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(_timers, -1), be_const_var(11) },
    { be_const_key(remove_driver, -1), be_const_closure(Tasmota_remove_driver_closure) },
    { be_const_key(_crons, -1), be_const_var(12) },
};
